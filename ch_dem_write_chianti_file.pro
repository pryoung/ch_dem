...
PRO ch_dem_write_chianti_file, data, dem_file, overwrite=overwrite

;+
; NAME:
;     CH_DEM_WRITE_CHIANTI_FILE
;
; PURPOSE:
...
;
; CALLING SEQUENCE:
;     CH_DEM_WRITE_CHIANTI_FILE, Data, Dem_File
;
; INPUTS:
...
;
; EXAMPLE:
;     IDL> ch_dem_write_chianti_file, output, 'flare_20240930.dem'
;
; MODIFICATION HISTORY:
;     Ver.1, 24-Nov-2025, Peter Young
;     Ver.2, 28-Apr-2026, Peter Young
;       Renamed to ch_dem_write_chianti_file and added to ch_dem repository.
;-
